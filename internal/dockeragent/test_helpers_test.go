...
type fakeDockerClient struct {
	...
	containerListFunc         func(ctx context.Context, opts containerListOptions) ([]containertypes.Summary, error)
	containerInspectWithRawFn func(ctx context.Context, id string, size bool) (containertypes.InspectResponse, []byte, error)
	containerStatsOneShotFn   func(ctx context.Context, id string) (containerStatsResult, error)
	containerInspectFn        func(ctx context.Context, id string) (containertypes.InspectResponse, error)
	imagePullFn               func(ctx context.Context, ref string, opts imagePullOptions) (io.ReadCloser, error)
	containerStopFn           func(ctx context.Context, id string, opts containerStopOptions) error
	...
	containerStartFn          func(ctx context.Context, id string, opts containerStartOptions) error
	containerRemoveFn         func(ctx context.Context, id string, opts containerRemoveOptions) error
	serviceListFn             func(ctx context.Context, opts serviceListOptions) ([]swarmtypes.Service, error)
	taskListFn                func(ctx context.Context, opts taskListOptions) ([]swarmtypes.Task, error)
...
func (f *fakeDockerClient) ContainerList(ctx context.Context, opts containerListOptions) ([]containertypes.Summary, error) {
...
func (f *fakeDockerClient) ContainerStatsOneShot(ctx context.Context, id string) (containerStatsResult, error) {
	if f.containerStatsOneShotFn == nil {
		return containerStatsResult{}, errors.New("unexpected ContainerStatsOneShot call")
	}
...
func (f *fakeDockerClient) ImagePull(ctx context.Context, ref string, opts imagePullOptions) (io.ReadCloser, error) {
...
func (f *fakeDockerClient) ContainerStop(ctx context.Context, id string, opts containerStopOptions) error {
...
func (f *fakeDockerClient) ContainerStart(ctx context.Context, id string, opts containerStartOptions) error {
...
func (f *fakeDockerClient) ContainerRemove(ctx context.Context, id string, opts containerRemoveOptions) error {
...
func (f *fakeDockerClient) ServiceList(ctx context.Context, opts serviceListOptions) ([]swarmtypes.Service, error) {
...
func (f *fakeDockerClient) TaskList(ctx context.Context, opts taskListOptions) ([]swarmtypes.Task, error) {
	if f.taskListFn == nil {
...
func statsReader(t *testing.T, stats containertypes.StatsResponse) containerStatsResult {
	t.Helper()
